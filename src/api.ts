...
export const injectCodex    = (provider: Provider, port: number): Promise<void> => invoke("inject_codex_cmd", { provider, port });
export const removeCodex    = (): Promise<void>                    => invoke("remove_codex_cmd");
export const injectHermes   = (provider: Provider, port: number): Promise<void> => invoke("inject_hermes_cmd", { provider, port });
...
export const injectOpenclaw = (provider: Provider, port: number): Promise<void> => invoke("inject_openclaw_cmd", { provider, port });
